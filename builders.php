...
<body>
    ...
    <main>
                    ...
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-content py-5">
                            <div class="section-title text-start">
                                <span class="short-title wow fadeInUp text-white">Builders Inventory LOAN</span>
                                <h1 class="text-white" data-wow-delay='0.2s'>Get your dream Builders Inventory with low rates and flexible terms</h1>
                            </div>
        ...
        <!-- features of Builders Inventoryloan -->
        ...
        <section class="bcard-feature-area bg_disable pt-lg-125 pt-105 pb-lg-140 pb-115">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="section-title">
                            <h2 class="wow fadeInUp">Key Features of DFin Builders Inventory Loans</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.3s">Explore the features that make our Builders Inventory loan services convenient and secure for you.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-30 gy-4">
                    <div class="col-md-4">
                        <div class="card">
                            <h2 class="text-white">Builder Inventory Funding</h2>
                            <p class="text-white">Min. Rs. 2 Crs</p>
                            <p class="text-white">Max Rs. 25 Crs
                            </p>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <h2 class="text-white">Builder Plot Purchase + Constr.</h2>
                            <p class="text-white">Min. Rs. 1 Cr</p>
                            <p class="text-white">Max Rs. 85 Crs
                            </p>
                            <a href="contact.php" class="apply-now-btn">Apply Now</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <h2 class="text-white">Builder Project Finance</h2>


                            <p class="text-white">Up to Rs. 250 Crs
                            </p>
        ...
        <!-- features of Builders Inventoryloan end -->
        ...
        <section class="why-choose-area pt-125 pb-135 overflow-hidden">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="section-title">
                            <h2 class="wow fadeInUp">Why Choose DFin Builders Inventory Loans?</h2>
                            <p class="wow fadeInUp text-white" data-wow-delay="0.3s">Discover the reasons to choose DFin for your Builders Inventory loan needs.</p>
                        </div>
                    </div>
                </div>
                <div class="row mt-55 gy-lg-0 gy-4">
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <p>Our Builders Inventory loan application process is designed to be user-friendly, making it easy for you to apply and navigate through the entire process.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p>Experience faster approval and disbursement processes, ensuring that you get the funds you need for your dream Builders Inventory without delays.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="content-box pr-lg-30 pl-lg-30 wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <p>Your financial security is our priority. Benefit from 100% secure transactions and data
                                protection throughout your Builders Inventory loan journey with DFin.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="cta-content text-black wow fadeInRight">
                            <h2>Unlock Your Dream Builders Inventory with DFin</h2>
                            <p>Explore our Builders Inventory loan options and take the first step towards Builders Inventory with DFin. Access flexible terms, competitive rates, and a seamless application process.</p>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="cta-content mt-3 mt-sm-0 text-sm-end text-center">
                            <a href="contact.php" class="theme-btn wow fadeInLeft">Get Builders Inventory Loan</a>
                        </div>
                    </div>
                </div>
            </div>
